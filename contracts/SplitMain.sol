...
contract SplitMain is ISplitMain {
  ...
  /**
  * @notice claim yield generated by split main and send it to the yield recipient.
  * @param _token rebasing token to claim yield from, WETH or USDB.
